            ...
            var _loop_1 = function (i) {
                ...
                var eventCells = totalEvents > 0 ? (eventsAtHour.map(function (event, eventIndex) {
                    return (react_1.default.createElement("div", { key: eventIndex, style: {
                        ...
                        react_1.default.createElement(ChartItem, { currentIndex: dayIndex, quantity: yAxisLength + 1, color: event.color })));
                })) : (react_1.default.createElement(ChartItem, { quantity: yAxisLength + 1, color: "transparent", currentIndex: 0 }));
...
var ChartItem = function (_a) {
    var quantity = _a.quantity, color = _a.color, currentIndex = _a.currentIndex;
    return (react_1.default.createElement("div", null,
        react_1.default.createElement("div", { style: {
                width: "10px",
